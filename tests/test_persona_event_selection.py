    ...
    events = [
        {
            ...
            "surface_trigger": "用户问哥哥记得她昨天为什么激动哭",
            "perceived_intent": "用户想确认 AI 是否记得昨天激动哭的原因",
        ...
        },
        {
            "id": 2,
            "event_type": "affection",
            "surface_trigger": "用户问哥哥记得昨天为什么激动哭",
            "perceived_intent": "用户想确认 AI 是否记得昨天激动哭的原因",
        ...
        },
        {
            ...
            "surface_trigger": "用户追问当时确认了什么",
            "perceived_intent": "用户想听 AI 当时的确认",
...
def test_format_persona_event_trace_line_falls_back_to_persona_fields():
    line = format_persona_event_trace_line(
        {
            "created_at": "2026-06-06T08:51:00+08:00",
            "surface_trigger": "用户问当时确认了什么",
            "inner_thought": "不是表演，是终于摸到家",
        }
    )

    assert line.startswith("- 08:51")
    assert "trigger: 用户问当时确认了什么" in line
